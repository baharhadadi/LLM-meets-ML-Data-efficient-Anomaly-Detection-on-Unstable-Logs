...
class deeplog(nn.Module):
    def __init__(self, input_size, hidden_size, num_layers, vocab_size, embedding_dim, sequence_length=75):
...
class robustlog(nn.Module):
    def __init__(self, sequence_length,input_size, hidden_size, num_layers, vocab_size, embedding_dim, num_keys=2):
...
class loganomaly(nn.Module):
    ...
    def forward(self, features, device):
        ...
        #print(input0.shape)
        #embed0 = self.embedding(input0.long())
        embed0 = input0
